...
import {GetAccessToken, Lipa_na_mpesa} from '../apiintergration/mpesa_api'
...
const CheckoutPage =(props) => {
    ...
    const callResponse = () => {
        fetch("http://localhost:8000/mpesa")
        .then(res => res.text())
        .then(res => this.setApiResponse({ apiResponse: res}))
    } 
    ...
    return (
        ...
        <div className="checkoutcart">
            <h3>Order Review</h3>
                ...
                <button className="store-btn" onClick={GetAccessToken}>Buy With Mpesa</button>
                </div>
        </div>
