        ...
        <div className="store-container" key={id}>
                    ...
                    <div className="store-content">
                        ...
                        <div className="btn-dispatch">
                            <span onClick={() => dispatch(decrementQuantity(id))} className="redux-store-btn" type="button" ><FaMinus /></span>
                            <span>{quantity}</span>
                            <Button shape="circle" onClick={() => dispatch(incrementQuantity(id))} className="redux-store-btn"><FaPlus/></Button>
